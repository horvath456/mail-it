...
TemplateConfigInputbox::TemplateConfigInputbox(form frm) : inbox{frm, "Bitte die Email-Zugangsdaten eingeben.", "Email-Zugangsdaten"},
                                           host{"Host"},
...
bool TemplateConfigInputbox::show()
{
    return inbox.show(host, port, username, password);
}

string TemplateConfigInputbox::get_host()
{
    return host.value();
}

int TemplateConfigInputbox::get_port()
{
    return port.value();
}

string TemplateConfigInputbox::get_username()
{
    return username.value();
}

string TemplateConfigInputbox::get_password()
{
